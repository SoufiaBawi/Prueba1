...
int main(){//funcion principal
    ...
    cout << "\n2. Calcular areas de triangulos";
    cout << "\n Elige una opciÃ³n: ";
    ...
    switch(Variable_opcion){//este es el cuerpo de los casos
            ...
            break;
            case 2:
                cout<<"\nHa elegido la opcion dos, eliga el triangulo:\n";
                cout<<"a. Triangulo Equilatero\n";
                cout<<"b. Cuadrado\n";
                cout<<"c. Circulo\n'";
            char opc2;
            ...
            switch(opc2){
                ...
                area = b * h / 2;
                cout<<"\nEl area de tu triangulo será: "<<area;
                    break;
                ...
                case 'b':
                    ...
                    cin>>l;
                    area = l*l;
                    cout<<"\nEl area de tu cuadrado será: "<<area; 
                    break;
